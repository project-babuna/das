const socialLinks = [
  ...
  {
    label: "YouTube",
    text: "DreamAndScale on YouTube",
    href: "https://www.youtube.com/@dreamandscale",
    path: "M21.58 7.19a2.77 2.77 0 0 0-1.95-1.96C17.9 4.77 12 4.77 12 4.77s-5.9 0-7.63.46a2.77 2.77 0 0 0-1.95 1.96A28.9 28.9 0 0 0 2 12a28.9 28.9 0 0 0 .42 4.81 2.77 2.77 0 0 0 1.95 1.96c1.73.46 7.63.46 7.63.46s5.9 0 7.63-.46a2.77 2.77 0 0 0 1.95-1.96A28.9 28.9 0 0 0 22 12a28.9 28.9 0 0 0-.42-4.81ZM10 15.27V8.73L15.45 12 10 15.27Z",
  },
  {
    label: "Facebook",
